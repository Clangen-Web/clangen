...
class ProfileScreen(Screens):
    ...
    def build_profile(self):
        ...
        self.profile_elements["favourite_button"] = UIButton(scale(pygame.Rect
                                                                        ((x_pos, 287), (56, 56))),
                                                                  "",
                                                                  object_id="#fav_cat",
                                                                  manager=MANAGER,
        ...
        self.profile_elements["not_favourite_button"] = UIButton(scale(pygame.Rect
                                                                            ((x_pos, 287),
                                                                             (56, 56))),
                                                                      "",
    ...
    def update_toggle_buttons(self):
        ...
        if self.the_cat.dead and game.settings["fading"]:
            ...
            self.checkboxes["prevent_fading"] = UIButton(scale(pygame.Rect((200, 770), (68, 68))), "",
                                                              starting_height=2,
    ...
    def toggle_history_tab(self, sub_tab_switch=False):
        ...
        if previous_open_tab == 'history' and sub_tab_switch is False:
            ...
            self.sub_tab_1 = UIButton(scale(pygame.Rect((1418, 950), (84, 60))), "", object_id="#sub_tab_1_button"
                                           , manager=MANAGER)
            self.sub_tab_1.disable()
            self.sub_tab_2 = UIButton(scale(pygame.Rect((1418, 1024), (84, 60))), "", object_id="#sub_tab_2_button"
                                           , manager=MANAGER)
            self.sub_tab_2.disable()
            self.sub_tab_3 = UIButton(scale(pygame.Rect((1418, 1098), (84, 60))), "", object_id="#sub_tab_3_button"
                                           , manager=MANAGER)
            self.sub_tab_3.disable()
            self.sub_tab_4 = UIButton(scale(pygame.Rect((1418, 1172), (84, 60))), "", object_id="#sub_tab_4_button"
                                           , manager=MANAGER)
            self.sub_tab_4.disable()
            self.fav_tab = UIButton(
                scale(pygame.Rect((105, 960), (56, 56))),
                "",
                object_id="#fav_star",
                tool_tip_text='un-favorite this tab', manager=MANAGER
            )
            self.not_fav_tab = UIButton(
                scale(pygame.Rect((105, 960), (56, 56))),
                "",
    ...
    def update_disabled_buttons_and_text(self):
        ...
        # Dangerous Tab
            ...
            if not self.the_cat.dead:
                ...
                if self.the_cat.dead and game.clan.instructor.ID == self.the_cat.ID:
                    self.exile_cat_button = UIButton(scale(pygame.Rect((1156, 900), (344, 92))),
                                                          "",
                                                          object_id=object_id,
        ...
        # History Tab:
            ...
            if self.open_sub_tab == 'life events':
                ...
                self.help_button = UIButton(scale(pygame.Rect(
                    (104, 1168), (68, 68))),
                    "",
                ...
                if self.editing_notes is True:
                    self.save_text = UIButton(scale(pygame.Rect(
                        (104, 1028), (68, 68))),
                        "",
                    ...
                    self.edit_text = UIButton(scale(pygame.Rect(
                        (104, 1028), (68, 68))),
                        "",
