...
class PatrolScreen(Screens):
    ...
    def open_choose_cats_screen(self):
        ...
        self.elements['last_page'] = UIButton(scale(pygame.Rect((150, 924), (68, 68))), "",
                                                   object_id="#patrol_last_page"
                                                   , manager=MANAGER)
        self.elements['next_page'] = UIButton(scale(pygame.Rect((482, 924), (68, 68))), "",
    ...
    def open_patrol_event_screen(self):
        ...
        self.elements["antagonize"] = UIButton(scale(pygame.Rect((1100, 980), (344, 72))), "",
